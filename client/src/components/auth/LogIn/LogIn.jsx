...
const Login = () => {
    ...
    return (
        <main className="min-h-screen flex">
            <div className="hidden lg:flex lg:flex-1 items-center justify-center bg-slate-300 h-screen">
            ...
            <div className="flex-1 flex items-center justify-center h-screen">
                <div className="w-full max-w-md space-y-6 text-gray-600 px-4 sm:px-8">
